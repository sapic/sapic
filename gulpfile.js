...
gulp.task('js', [/*'css2'*/], function() {
   ...
   return gulp.src(['./js/jquery.min.js', './js/store.everything.min.js', './js/release.js', './js/linq.min.js', './js/jquery.smooth-scroll.min.js', './js/interact-1.2.2.min.js',, './js/index.js'])
      .pipe(concat('main.js'))
      .pipe(uglify())
      .pipe(gulp.dest('./out'));
});
